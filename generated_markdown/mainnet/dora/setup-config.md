...
wget -O $HOME/.dora/config/genesis.json https://server-3.itrocket.net/mainnet/dora/genesis.json
wget -O $HOME/.dora/config/addrbook.json https://server-3.itrocket.net/mainnet/dora/addrbook.json
